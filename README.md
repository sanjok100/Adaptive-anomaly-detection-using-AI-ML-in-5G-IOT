...
4) Class Balancing
-The training set is balanced using oversampling to prevent bias toward the majority class.
...
-GridSearchCV with 5-fold cross-validation is used to find the best:
