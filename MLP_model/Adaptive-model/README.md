...
This project implements an adaptive anomaly detection framework using a Multi-Layer Perceptron (MLP) model for intrusion detection in 5G-enabled IoT environments using the 5G-NIDD dataset.
...
The framework also includes adaptive learning mechanisms through dynamic confidence thresholding and concept drift detection using ADWIN.
...
Objective:
Detect whether traffic is benign or malicious.
...
Objective:
Identify the exact attack type.
...
pip install tensorflow scikit-learn==1.4.2 scikeras river pandas numpy matplotlib seaborn
